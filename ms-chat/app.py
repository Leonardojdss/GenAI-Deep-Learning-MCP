...
import asyncio
from client_server_claude import MCPClient
...
st.markdown("<h1 style='text-align: center;'>Análise de Crédito com MCP</h1>", unsafe_allow_html=True)
...
prompt = st.chat_input("Chat com seu banco")
